...
export default function MaharashtraDistrictsGrid() {
  ...
  const districtsConfig = {
    "Mumbai": { scale: 29000, center: [72.85, 18.95], translateX: 0, translateY: 0, zoom: 1.2 },
    "Pune": { scale: 4000, center: [74.37, 18.64], translateX: 0, translateY: 0, zoom: 1 },
    "Nagpur": { scale: 5100, center: [79.08, 21.15], translateX: 0, translateY: 0, zoom: 1 },
    "Thane": { scale: 6000, center: [73.26, 19.2], translateX: 0, translateY: 0, zoom: 1 },
    "Nashik": { scale: 4000, center: [74.05, 20.10], translateX: 0, translateY: 0, zoom: 1 },
    "Aurangabad": { scale: 4000, center: [75.34, 19.88], translateX: 0, translateY: 0, zoom: 1 },
    "Solapur": { scale: 4000, center: [75.59, 17.67], translateX: 0, translateY: 0, zoom: 1 },
    "Amravati": { scale: 4000, center: [77.75, 20.93], translateX: 0, translateY: 0, zoom: 1 },
    "Kolhapur": { scale: 5000, center: [74.23, 16.4], translateX: 0, translateY: 0, zoom: 1 },
    "Jalgaon": { scale: 4200, center: [75.57, 20.89], translateX: 0, translateY: 0, zoom: 1 },
    "Akola": { scale: 6300, center: [77.1, 20.7], translateX: 0, translateY: 0, zoom: 1 },
    "Satara": { scale: 6000, center: [74.2, 17.7], translateX: 0, translateY: 0, zoom: 1 },
    "Latur": { scale: 7500, center: [76.78, 18.4], translateX: 0, translateY: 0, zoom: 1 },
    "Dhule": { scale: 6000, center: [74.55, 21.0], translateX: 0, translateY: 0, zoom: 1 },
