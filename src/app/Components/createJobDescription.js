  ...
  return (
    <>
        ...
        <div className="grid grid-cols-2 gap-4 mt-2 text-[13px] px-5 py-5 rounded-xl bg-gray-200">
          <div>
            ...
            <div className="overflow-hidden">
              <div className="h-1 bg-red-600 mt-1 w-full max-w-[280px]"></div>{" "}
              {/* Adjust max width */}
            </div>
          </div>
          ...
          <div>
            ...
            <div className="overflow-hidden">
              <div className="h-1 bg-yellow-600 mt-1 w-full max-w-[250px]"></div>{" "}
              {/* Adjust max width */}
            </div>
          </div>
          ...
          <div>
            ...
            <div className="overflow-hidden">
              <div className="h-1 bg-blue-600 mt-1 w-full max-w-[100px]"></div>{" "}
              {/* Adjust max width */}
            </div>
          </div>
          ...
          <div>
            ...
            <div className="overflow-hidden">
              <div className="h-1 bg-red-600 mt-1 w-full max-w-[200px]"></div>{" "}
              {/* Adjust max width */}
            </div>
          </div>
        </div>
      ...
      <div className="mb-6">
        ...
        <input
          type="text"
          className="w-full border rounded-lg p-2 pl-4 placeholder:text-sm"
      ...
      <div className="mb-6">
        ...
        <select className="w-full border text-sm rounded-lg p-3 pl-4 text-gray-400 bg-white" >
          <option selected defaultValue="15">
            Within 15 mins
          </option>
      ...
      <div className="mb-6 rounded-lg">
        ...
        <div className="bg-gray-100 p-5">
          ...
          <div className="flex gap-2 mb-2">
            <span className="bg-blue-300 text-blue-800 text-xs px-5 py-2 rounded-full">
              English
            </span>
            <span className="bg-blue-300 text-blue-800 text-xs px-5 py-2 rounded-full">
              Marathi
          ...
          <div className="mb-2">
            ...
            <span className="text-xs text-gray-400">
              Coastal climate, Heavy rainfall
            </span>
          </div>
          <div className="mb-2">
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-wrap gap-2 pl-3">
          <span className="bg-yellow-100 text-green-800 text-xs px-3 py-2 rounded-full">
            Flood Response
          </span>
          <span className="bg-yellow-100 text-green-800 text-xs px-3 py-2 rounded-full">
            Water Rescue
      ...
      <div className="mb-6">
        ...
        <textarea
          className="w-full border rounded-xl p-3 placeholder:text-sm"
          placeholder="Enter any additional job description..."
        ></textarea>
      </div>

      {/* Save Button */}
      <div className="flex justify-end">
        <button className="w-36 bg-purple-700 text-white py-2 rounded-xl">
          Save
        </button>
      </div>
    </>
